...
def model_train(train_mix, train_config):
    ...
    X_train = train_use.loc[((train_use['item_first_sale']==0)|(train_use['item_shop_first_sale']==0))&(train_use.date_block_num <= 33), train_config.features]
    y_train = train_use.loc[((train_use['item_first_sale']==0)|(train_use['item_shop_first_sale']==0))&(train_use.date_block_num <= 33), 'item_cnt_month']
...
if __name__ == "__main__":
    ...
    sample_submission.to_csv(f'../results/wo_history/submission_wo_history_{t_config.model_type}_{t_config.seed}.csv', index=False)
